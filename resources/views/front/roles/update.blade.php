        ...
        <!--breadcrumb-->
				<div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
					...
					<div class="ms-auto">
						<div class="btn-group">
                            @can('add')
							<a href="{{route('front.add_role')}}" class="btn btn-primary">Add Front Role</a>
                            @endcan
						</div>
					</div>
				</div>
                ...
                <div class="col-12 col-xl-8 order-xl-3">
                  <div class="card-body p-4 p-sm-5">
                     ...
                     <form method="post"
                     action="{{route('front.edit_role',$front_role->id)}}" class="form-body">@csrf 
                        <div class="row g-3">
                          <div class="col-12 ">
                            ...
                            <div class="ms-auto position-relative">
                              ...
                              <input type="text" class="form-control radius-30 ps-5" id="inputName" name="role" value="{{$front_role->name}}" 
