            ...
            <div class="col-md-12">
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    ...
                    <div class="tab-pane fade shadow rounded bg-white show active p-5" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        ...
                        <h2 class="font-italic mb-4">PUblisher's Message</h2>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                         @php 
                         $sender = User::where('id',$message->from_user_id)->first();
                         echo $sender->name;
                         @endphp
                        </td>
                        ...
                        <td>
                            @php 
                            $paper = Paper::where('id',$message->paper_id)->first();
...
<div class="modal" id="myModal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal Header -->
      <form method="POST" enctype="multipart/form-data" action="{{route('author.respond_toPublisher')}}">@csrf
      ...
      <div class="modal-body">
            ...
            <div class="col-md-12">
                <div class="form-group">
                     ...
                     <input type="file" name="file_toPublish" class="form-control"><br>
