        ...
        <!--breadcrumb-->
                ...
                <div class="col-12 col-xl-8 order-xl-3">
                  <div class="card-body p-4 p-sm-5">
                     ...
                     <form method="post" 
                     action="{{route('site_identity_logo')}}"
                     enctype="multipart/form-data" class="form-body">@csrf
                        ...
                        <div class="row g-3">
                          ...
                          <div class="col-12 ">
                            ...
                            @endif
                             id="logo_display" onclick="triggerclick()" width="50px" height="50px" alt="User Image"> <br/>
                            <input type="file" class="form-control" name="logo_image" onchange="displayImage(this)" id="logo_image" style="display: none;">
                          ...
                          <div class="col-12">
                            <div class="d-grid">
                              <button type="submit" class="btn btn-primary radius-30">Update Logo</button>
                            </div>
                          </div>
